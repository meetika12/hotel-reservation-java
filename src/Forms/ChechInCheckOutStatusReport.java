...
public class ChechInCheckOutStatusReport extends javax.swing.JFrame {

    
    public ChechInCheckOutStatusReport() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblAllOccupiedRooms.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Room No", "Name", "Address", "Phone", "Check In Date", "Check Out Date", "Charges"
            }
        ) {
    ...
    private void btnLoadReportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadReportActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[]{custID,roomNo,custName,address,phone,checkInDate,CheckOutDate,charges});
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChechInCheckOutStatusReport().setVisible(true);
            }
        });
    }
